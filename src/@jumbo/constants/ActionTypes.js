...
// For System Running Number
export const INITIAL_SYSTEM_RUNNING_NUMBER = 'initial_system_running_number';
export const GET_SYSTEM_RUNNING_NUMBER = 'get_system_running_number';
export const GET_SYSTEM_RUNNING_NUMBER_SUCCESS = 'get_system_running_number_success';
export const GET_SYSTEM_RUNNING_NUMBER_ERROR = 'get_system_running_number_error';
export const RELEASE_SYSTEM_RUNNING_NUMBER = 'release_system_running';
export const RELEASE_SYSTEM_RUNNING_NUMBER_SUCCESS = 'release_system_running_success';
export const RELEASE_SYSTEM_RUNNING_NUMBER_ERROR = 'release_system_running_error';
